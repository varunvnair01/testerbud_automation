📌 TesterBud Practice Form Automation
🚀 Project Overview

This project automates the TesterBud Practice Forms page using Selenium WebDriver with Java in Eclipse. It performs end-to-end form interactions,
...
Used JavaScriptExecutor to interact with non-interactable elements
Implemented implicit waits for stable and consistent execution
Located dynamic and complex elements using XPath
